...
with tab1:
    # คำแนะนำสำหรับแท็บกล้อง
    st.info("💡 **วิธีใช้งานกล้อง:** 1. อนุญาตให้เว็บเข้าถึงกล้อง ➔ 2. ถ่ายรูปสลากส่วนผสมให้ชัดเจน ➔ 3. รอ AI ประมวลผล")
    camera_file = st.camera_input("ถ่ายรูปสลากผลิตภัณฑ์ให้ชัดเจน")
    
with tab2:
    # คำแนะนำสำหรับแท็บอัปโหลด
    st.info("💡 **วิธีอัปโหลดรูป:** 1. ถ่ายรูปหรือครอปรูปส่วนผสมเตรียมไว้ ➔ 2. กดปุ่ม Browse files ด้านล่าง ➔ 3. รอ AI ประมวลผล")
